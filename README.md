...
<table border="0">
 ...
 <tr>
    <td>Python, <br>R, <br>Tableau Public, <br>Figma</td>
...
<img src='https://github.com/wjsutton/why_does_my_dog/blob/master/Dash.png?raw=true' width="100%">
</a>
</div>
...
The background of this visualisation was created in Figma, including all the static text using the font: BentonSans Regular (same as Tableau Regular)
